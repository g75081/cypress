...
```shell
$ docker run -it -v C:/Projects_Jenkins/demo-docker-cypress-included:/e2e -w /e2e --entrypoint=cypress cypress/included:3.2.0 help
```
...
```shell
$ docker run -it -v C:/Projects_Jenkins/demo-docker-cypress-included:/e2e -w /e2e --entrypoint=cypress cypress/included:6.2.1 info
